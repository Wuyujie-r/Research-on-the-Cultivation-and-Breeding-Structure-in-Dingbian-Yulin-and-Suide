# =============================================================================
# 第三章：陕北农牧交错区耕种-养殖结构静态类型与动态演变类型分析
...
# ------------------------------ 2. 路径设置 -----------------------------------
input_file <- "清洗后核心变量.xlsx"  #此处填写对应数据路径
output_dir <- "第三章结果"  #此处填写输出文件路径
...
# 7.3 养殖规模变化
# 注意：问卷中无直接询问养殖规模变化，以下为占位符（全部设为稳定），
